  ...
  return (
    <div className='bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 bg-cover pb-6'>
      ...
      <h1 className="text-3xl text-center mt-5 text-gray-800">Car Details</h1>
        ...
        <center className=''>
          <input type='button' value='Post' onClick={post} className=' text-white mt-6 bg-red-600 w-28 h-8 rounded-2xl border-black hover:bg-fuchsia-600 cursor-pointer align-middle text-center' /><br /><br />
        </center>
        <div>
